    ...
    $.post(
            ...
            function (data) {
                ...
                $.each(data, function (i, testerID) {
                    display += "<option class='tstID' value='" + testerID.New_Tester_ID + "'>" + testerID.New_Tester_ID + "</option>";
                });
...
$(".filter").change(function () {
    ...
    var tstpf = $("#tstpf").val();
    var tstID = $("#tstID").val();
    var controller_map = "promis/show_filtered_machine_BI";
    ...
    $.post(
            ...
            function (data) {
                ...
                $.each(data, function (i, FOLData) {
                    ...
                    display += "<tr class='hover table-refresh' id='biID' style='cursor: pointer;" + style + "' data-machine-id=" + FOLData.id + ">";
                    display += "<td class='lalign table-refresh'>" + FOLData.File_DateTime + "</td>";
                    display += "<td class='tsID table-refresh'>" + FOLData.New_Tester_ID + "</td>";
